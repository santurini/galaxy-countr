...
# as done for the training step, we will keep most of CounTR code for testing
# as we will try to test based on their code
def get_args_parser():
    ...
    # Dataset parameters : here we place our data
    parser.add_argument('--data_path', default='../../data/GalaxiesV2', type=str,
                        help='dataset path')
    # default our folders 
    parser.add_argument('--output_dir', default='../../output/loro_aug_100_epoche/testing',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='../../output/loro_aug_100_epoche/testing',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='../../loro_aug_100_epoche/output/checkpoint-99.pth',
...
# this is mostly the same as their code, it works as we prepared data to fit well
...
# for the next step, most of CounTR code is kept and some is removed and modified
# to adapt their testing to our model.
def main(args):
    ...
    plt.ylabel('Error')
    plt.savefig(f'../../output/loro_aug_100_epoche/testing/test_stat.png')
    plt.show()
